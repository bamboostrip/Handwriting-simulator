...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_top = QtWidgets.QLabel(self.group_margin)
        gm.addWidget(self.label_top, 0, 0)
        self.lineEdit_3 = QtWidgets.QLineEdit(self.group_margin)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit_3.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        gm.addWidget(self.lineEdit_3, 0, 1)
        self.label_bottom = QtWidgets.QLabel(self.group_margin)
        gm.addWidget(self.label_bottom, 0, 2)
        self.lineEdit_4 = QtWidgets.QLineEdit(self.group_margin)
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_4.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        gm.addWidget(self.lineEdit_4, 0, 3)
        self.label_left = QtWidgets.QLabel(self.group_margin)
        gm.addWidget(self.label_left, 1, 0)
        self.lineEdit_5 = QtWidgets.QLineEdit(self.group_margin)
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.lineEdit_5.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        gm.addWidget(self.lineEdit_5, 1, 1)
        self.label_right = QtWidgets.QLabel(self.group_margin)
        gm.addWidget(self.label_right, 1, 2)
        self.lineEdit_6 = QtWidgets.QLineEdit(self.group_margin)
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.lineEdit_6.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        gm.addWidget(self.lineEdit_6, 1, 3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_top.setText(_translate("Form", "上"))
        self.lineEdit_3.setPlaceholderText("30")
        self.label_bottom.setText(_translate("Form", "下"))
