...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # 标记工具：划选后一键设为打印/角色（背景色预览）
        row_marks = QtWidgets.QHBoxLayout()
        self.btn_mark_print = QtWidgets.QPushButton(panel)
        self.btn_mark_print.setObjectName("btn_mark_print")
        self.btn_mark_role1 = QtWidgets.QPushButton(panel)
        self.btn_mark_role1.setObjectName("btn_mark_role1")
        self.btn_mark_role2 = QtWidgets.QPushButton(panel)
        self.btn_mark_role2.setObjectName("btn_mark_role2")
        self.btn_mark_clear = QtWidgets.QPushButton(panel)
        self.btn_mark_clear.setObjectName("btn_mark_clear")
        row_marks.addWidget(self.btn_mark_print)
        row_marks.addWidget(self.btn_mark_role1)
        row_marks.addWidget(self.btn_mark_role2)
        row_marks.addWidget(self.btn_mark_clear)
        row_marks.addStretch(1)
        v.addLayout(row_marks)
        ...
        # 笔迹角色管理（多角色手写槽位，动态高亮映射）
        self.group_roles = QtWidgets.QGroupBox(panel)
        self.group_roles.setObjectName("group_roles")
        gro = QtWidgets.QVBoxLayout(self.group_roles)
        self.label_roles_hint = QtWidgets.QLabel(self.group_roles)
        self.label_roles_hint.setWordWrap(True)
        self.label_roles_hint.setProperty("hint", True)
        gro.addWidget(self.label_roles_hint)
        self.role_list = QtWidgets.QListWidget(self.group_roles)
        self.role_list.setObjectName("role_list")
        self.role_list.setMinimumHeight(72)
        self.role_list.setMaximumHeight(130)
        gro.addWidget(self.role_list)
        row_role_btns = QtWidgets.QHBoxLayout()
        self.btn_role_add = QtWidgets.QPushButton(self.group_roles)
        self.btn_role_add.setObjectName("btn_role_add")
        row_role_btns.addWidget(self.btn_role_add)
        self.btn_role_edit = QtWidgets.QPushButton(self.group_roles)
        self.btn_role_edit.setObjectName("btn_role_edit")
        row_role_btns.addWidget(self.btn_role_edit)
        self.btn_role_del = QtWidgets.QPushButton(self.group_roles)
        self.btn_role_del.setObjectName("btn_role_del")
        row_role_btns.addWidget(self.btn_role_del)
        self.btn_role_manage = QtWidgets.QPushButton(self.group_roles)
        self.btn_role_manage.setObjectName("btn_role_manage")
        row_role_btns.addWidget(self.btn_role_manage)
        row_role_btns.addStretch(1)
        gro.addLayout(row_role_btns)
        v.addWidget(self.group_roles)
    ...
    def retranslateUi(self, Form):
        ...
        self.group_roles.setTitle(_translate("Form", "笔迹角色管理"))
        self.label_roles_hint.setText(_translate("Form", "动态映射：Word 中首次出现的背景色→手写角色1，次出现→手写角色2… 在此调整各角色字体/颜色/扰动。"))
        self.btn_role_add.setText(_translate("Form", "新增"))
        self.btn_role_edit.setText(_translate("Form", "编辑"))
        self.btn_role_del.setText(_translate("Form", "删除"))
        self.btn_role_manage.setText(_translate("Form", "管理…"))
        self.btn_mark_print.setText(_translate("Form", "设为打印"))
        self.btn_mark_print.setToolTip(_translate("Form", "将选中文字设为打印体（灰底）"))
        self.btn_mark_role1.setText(_translate("Form", "角色1 黄"))
        self.btn_mark_role1.setToolTip(_translate("Form", "设为手写角色1（黄底）"))
        self.btn_mark_role2.setText(_translate("Form", "角色2 绿"))
        self.btn_mark_role2.setToolTip(_translate("Form", "设为手写角色2（绿底）"))
        self.btn_mark_clear.setText(_translate("Form", "清除标记"))
        self.btn_mark_clear.setToolTip(_translate("Form", "清除选中文字的角色标记，回到默认手写"))
